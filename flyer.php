...
<div class="other-tools">
        ...
        <div href="#" class="card-item">
                <img src="Images/f1.jpg" alt="Card Image">
                <a href="Images/f1.jpg" id="downloadimg" download="Flyer">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
                <img src="Images/f2.jpg" alt="Card Image">
                <a href="Images/f2.jpg" id="downloadimg" download="Flyer">DOWNLOAD</a>
            </div>

            <div href="#" class="card-item">
            <img src="Images/f3.jpg" alt="Card Image">
            <a href="Images/f3.jpg" id="downloadimg" download="Flyer">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
            <img src="Images/f4.jpg" alt="Card Image">
            <a href="Images/f4.jpg" id="downloadimg" download="Flyer">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
            <img src="Images/f5.jpg" alt="Card Image">
            <a href="Images/f5.jpg" id="downloadimg" download="Flyer">DOWNLOAD</a>
        </div>

        <div href="#" class="card-item">
            <img src="Images/f6.jpg" alt="Card Image">
            <a href="Images/f6.jpg" id="downloadimg" download="Flyer">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
            <img src="Images/f7.jpg" alt="Card Image">
            <a href="Images/f7.jpg" id="downloadimg" download="Flyer">DOWNLOAD</a>
        </div>

        <div href="#" class="card-item">
            <img src="Images/f8.jpg" alt="Card Image">
            <a href="Images/f8.jpg"  id="downloadimg" download="Flyer">DOWNLOAD</a>
        </div>
        </div>
    </div>

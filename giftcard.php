...
<div class="other-tools">
        ...
        <div href="#" class="card-item">
                <img src="Images/gc1.jpg" alt="Card Image">
                <a href="Images/gc1.jpg" id="downloadimg" download="Gift Card">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
                <img src="Images/gc2.jpg" alt="Card Image">
                <a href="Images/gc2.jpg" id="downloadimg" download="Gift Card">DOWNLOAD</a>
            </div>

            <div href="#" class="card-item">
            <img src="Images/gc3.jpg" alt="Card Image">
            <a href="Images/gc3.jpg" id="downloadimg" download="Gift Card">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
            <img src="Images/gc4.jpg" alt="Card Image">
            <a href="Images/gc4.jpg" id="downloadimg" download="Gift Card">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
            <img src="Images/gc5.jpg" alt="Card Image">
            <a href="Images/gc5.jpg" id="downloadimg" download="Gift Card">DOWNLOAD</a>
        </div>

        <div href="#" class="card-item">
            <img src="Images/gc6.jpg" alt="Card Image">
            <a href="Images/gc6.jpg" id="downloadimg" download="Gift Card">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
            <img src="Images/gc7.jpg" alt="Card Image">
            <a href="Images/gc7.jpg" id="downloadimg" download="Gift Card">DOWNLOAD</a>
        </div>

        <div href="#" class="card-item">
            <img src="Images/gc8.jpg" alt="Card Image">
            <a href="Images/gc8.jpg"  id="downloadimg" download="Gift Card">DOWNLOAD</a>
        </div>
        </div>
    </div>

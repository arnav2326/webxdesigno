...
<div class="other-tools">
        ...
        <div href="#" class="card-item">
                <img src="Images/i1.jpg" alt="Card Image">
                <a href="Images/i1.jpg" id="downloadimg" download="Icons">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
                <img src="Images/i2.jpg" alt="Card Image">
                <a href="Images/i2.jpg" id="downloadimg" download="Icons">DOWNLOAD</a>
            </div>

            <div href="#" class="card-item">
            <img src="Images/i3.jpg" alt="Card Image">
            <a href="Images/i3.jpg" id="downloadimg" download="Icons">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
            <img src="Images/i4.jpg" alt="Card Image">
            <a href="Images/i4.jpg" id="downloadimg" download="Icons">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
            <img src="Images/i5.jpg" alt="Card Image">
            <a href="Images/i5.jpg" id="downloadimg" download="Icons">DOWNLOAD</a>
        </div>

        <div href="#" class="card-item">
            <img src="Images/i6.jpg" alt="Card Image">
            <a href="Images/i6.jpg" id="downloadimg" download="Icons">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">    
            <img src="Images/i7.jpg" alt="Card Image">
            <a href="Images/i7.jpg" id="downloadimg" download="Icons">DOWNLOAD</a>
        </div>

        <div href="#" class="card-item">
            <img src="Images/i8.jpg" alt="Card Image">
            <a href="Images/i8.jpg"  id="downloadimg" download="Icons">DOWNLOAD</a>
        </div>
        </div>
    </div>

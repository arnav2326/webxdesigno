<!DOCTYPE html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="imageenhancer.css"> 
    ...
    <a href="#" class="card-item">
        ...
        <h4>It can be used to get colors for your designs.</h4>
            ...
            <a href="#" class="card-item">
                ...
                <span class="tool-btn">QR Code Generator</span>
                <h4>It helps to convert link into QR Code to upload on images.</h4>
            </a>
            <a href="#" class="card-item">
                <img src="Images/bgr.jpg" alt="Card Image">
                <span class="tool-btn">Remove Background</span>
                <h4>It helps you to make changes on your image instantly.</h4>
            </a>
        </div>
    </div>
        <!-- Footer Starts -->

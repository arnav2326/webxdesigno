...
<link rel="stylesheet" href="instaposts.css">
...
<div class="other-tools">
        ...
        <div href="#" class="card-item">
                <img src="Images/in1.jpg" alt="Card Image">
                <a href="Images/in1.jpg" id="downloadimg" download="Posts">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
                <img src="Images/in2.jpg" alt="Card Image">
                <a href="Images/in2.jpg" id="downloadimg" download="Posts">DOWNLOAD</a>
            </div>

            <div href="#" class="card-item">
            <img src="Images/in3.jpg" alt="Card Image">
            <a href="Images/in3.jpg" id="downloadimg" download="Posts">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
            <img src="Images/in4.jpg" alt="Card Image">
            <a href="Images/in4.jpg" id="downloadimg" download="Posts">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
            <img src="Images/in5.jpg" alt="Card Image">
            <a href="Images/in5.jpg" id="downloadimg" download="Posts">DOWNLOAD</a>
        </div>

        <div href="#" class="card-item">
            <img src="Images/in6.jpg" alt="Card Image">
            <a href="Images/in6.jpg" id="downloadimg" download="Posts">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">    
            <img src="Images/in7.jpg" alt="Card Image">
            <a href="Images/in7.jpg" id="downloadimg" download="Posts">DOWNLOAD</a>
        </div>

        <div href="#" class="card-item">
            <img src="Images/in8.jpg" alt="Card Image">
            <a href="Images/in8.jpg"  id="downloadimg" download="Posts">DOWNLOAD</a>
        </div>
        </div>
    </div>

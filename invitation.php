...
<div class="other-tools">
        ...
        <div href="#" class="card-item">
                <img src="Images/iv1.jpg" alt="Card Image">
                <a href="Images/iv1.jpg" id="downloadimg" download="Invitations">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
                <img src="Images/iv2.jpg" alt="Card Image">
                <a href="Images/iv2.jpg" id="downloadimg" download="Invitations">DOWNLOAD</a>
            </div>

            <div href="#" class="card-item">
            <img src="Images/iv3.jpg" alt="Card Image">
            <a href="Images/iv3.jpg" id="downloadimg" download="Invitations">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
            <img src="Images/iv4.jpg" alt="Card Image">
            <a href="Images/iv4.jpg" id="downloadimg" download="Invitations">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
            <img src="Images/iv5.jpg" alt="Card Image">
            <a href="Images/iv5.jpg" id="downloadimg" download="Invitations">DOWNLOAD</a>
        </div>

        <div href="#" class="card-item">
            <img src="Images/iv6.jpg" alt="Card Image">
            <a href="Images/iv6.jpg" id="downloadimg" download="Invitations">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">    
            <img src="Images/iv7.jpg" alt="Card Image">
            <a href="Images/iv7.jpg" id="downloadimg" download="Invitations">DOWNLOAD</a>
        </div>

        <div href="#" class="card-item">
            <img src="Images/iv8.jpg" alt="Card Image">
            <a href="Images/iv8.jpg"  id="downloadimg" download="Invitations">DOWNLOAD</a>
        </div>
        </div>
    </div>

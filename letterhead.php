...
<div class="other-tools">
        ...
        <div href="#" class="card-item">
                <img src="Images/lt1.jpg" alt="Card Image">
                <a href="Images/lt1.jpg" id="downloadimg" download="Letterhead">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
                <img src="Images/lt2.jpg" alt="Card Image">
                <a href="Images/lt2.jpg" id="downloadimg" download="Letterhead">DOWNLOAD</a>
            </div>

            <div href="#" class="card-item">
            <img src="Images/lt3.jpg" alt="Card Image">
            <a href="Images/lt3.jpg" id="downloadimg" download="Letterhead">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
            <img src="Images/lt4.jpg" alt="Card Image">
            <a href="Images/lt4.jpg" id="downloadimg" download="Letterhead">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
            <img src="Images/lt5.jpg" alt="Card Image">
            <a href="Images/lt5.jpg" id="downloadimg" download="Letterhead">DOWNLOAD</a>
        </div>

        <div href="#" class="card-item">
            <img src="Images/lt6.jpg" alt="Card Image">
            <a href="Images/lt6.jpg" id="downloadimg" download="Letterhead">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">    
            <img src="Images/lt7.jpg" alt="Card Image">
            <a href="Images/lt7.jpg" id="downloadimg" download="Letterhead">DOWNLOAD</a>
        </div>

        <div href="#" class="card-item">
            <img src="Images/lt8.jpg" alt="Card Image">
            <a href="Images/lt8.jpg"  id="downloadimg" download="Letterhead">DOWNLOAD</a>
        </div>
        </div>
    </div>

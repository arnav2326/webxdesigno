...
<div class="other-tools">
        ...
        <div href="#" class="card-item">
                <img src="Images/pc1.jpg" alt="Card Image">
                <a href="Images/pc1.jpg" id="downloadimg" download="Post Card">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
                <img src="Images/pc2.jpg" alt="Card Image">
                <a href="Images/pc2.jpg" id="downloadimg" download="Post Card">DOWNLOAD</a>
            </div>

            <div href="#" class="card-item">
            <img src="Images/pc3.jpg" alt="Card Image">
            <a href="Images/pc3.jpg" id="downloadimg" download="Post Card">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
            <img src="Images/pc4.jpg" alt="Card Image">
            <a href="Images/pc4.jpg" id="downloadimg" download="Post Card">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
            <img src="Images/pc5.jpg" alt="Card Image">
            <a href="Images/pc5.jpg" id="downloadimg" download="Post Card">DOWNLOAD</a>
        </div>

        <div href="#" class="card-item">
            <img src="Images/pc6.jpg" alt="Card Image">
            <a href="Images/pc6.jpg" id="downloadimg" download="Post Card">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">    
            <img src="Images/pc7.jpg" alt="Card Image">
            <a href="Images/pc7.jpg" id="downloadimg" download="Post Card">DOWNLOAD</a>
        </div>

        <div href="#" class="card-item">
            <img src="Images/pc8.jpg" alt="Card Image">
            <a href="Images/pc8.jpg"  id="downloadimg" download="Post Card">DOWNLOAD</a>
        </div>
        </div>
    </div>

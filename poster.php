...
<div class="other-tools">
        ...
        <div href="#" class="card-item">
                <img src="Images/poster1.jpg" alt="Card Image">
                <a href="Images/poster1.jpg" id="downloadimg" download="Poster">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
                <img src="Images/poster2.jpg" alt="Card Image">
                <a href="Images/poster2.jpg" id="downloadimg" download="Poster">DOWNLOAD</a>
            </div>

            <div href="#" class="card-item">
            <img src="Images/poster3.jpg" alt="Card Image">
            <a href="Images/poster3.jpg" id="downloadimg" download="Poster">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
            <img src="Images/poster4.jpg" alt="Card Image">
            <a href="Images/poster4.jpg" id="downloadimg" download="Poster">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
            <img src="Images/poster5.jpg" alt="Card Image">
            <a href="Images/poster5.jpg" id="downloadimg" download="Poster">DOWNLOAD</a>
        </div>

        <div href="#" class="card-item">
            <img src="Images/poster6.jpg" alt="Card Image">
            <a href="Images/poster6.jpg" id="downloadimg" download="Poster">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">    
            <img src="Images/poster7.jpg" alt="Card Image">
            <a href="Images/poster7.jpg" id="downloadimg" download="Poster">DOWNLOAD</a>
        </div>

        <div href="#" class="card-item">
            <img src="Images/poster8.jpg" alt="Card Image">
            <a href="Images/poster8.jpg"  id="downloadimg" download="Poster">DOWNLOAD</a>
        </div>
        </div>
    </div>

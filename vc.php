...
<div class="other-tools">
        ...
        <div href="#" class="card-item">
                <img src="Images/vc1.jpg" alt="Card Image">
                <a href="Images/vc1.jpg" id="downloadimg" download="Visiting Card">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
                <img src="Images/vc2.jpg" alt="Card Image">
                <a href="Images/vc2.jpg" id="downloadimg" download="Visiting Card">DOWNLOAD</a>
            </div>

            <div href="#" class="card-item">
            <img src="Images/vc3.jpg" alt="Card Image">
            <a href="Images/vc3.jpg" id="downloadimg" download="Visiting Card">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
            <img src="Images/vc4.jpg" alt="Card Image">
            <a href="Images/vc4.jpg" id="downloadimg" download="Visiting Card">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">
            <img src="Images/vc5.jpg" alt="Card Image">
            <a href="Images/vc5.jpg" id="downloadimg" download="Visiting Card">DOWNLOAD</a>
        </div>

        <div href="#" class="card-item">
            <img src="Images/vc6.jpg" alt="Card Image">
            <a href="Images/vc6.jpg" id="downloadimg" download="Visiting Card">DOWNLOAD</a>
        </div>

            <div href="#" class="card-item">    
            <img src="Images/vc7.jpg" alt="Card Image">
            <a href="Images/vc7.jpg" id="downloadimg" download="Visiting Card">DOWNLOAD</a>
        </div>

        <div href="#" class="card-item">
            <img src="Images/vc8.jpg" alt="Card Image">
            <a href="Images/vc8.jpg"  id="downloadimg" download="Visiting Card">DOWNLOAD</a>
        </div>
        </div>
    </div>
